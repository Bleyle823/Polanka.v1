    ...
    <div className="bg-indigo-900 relative overflow-hidden h-screen">
      ...
      <header className="absolute top-0 left-0 right-0 z-20">
        ...
        <section>
          <div className="animate-none sm:animate-pulse relative items-center w-full px-5 py-18 mx-auto  md:px-12 lg:px-24 max-w-7xl">
            <div className="p-6 border-l-4 border-pink-500 -6 rounded-r-xl bg-pink-50">
              <div className="flex">
                ...
                <div className="ml-3">
                  <div className="text-sm text-pink-600 capitalize">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 flex items-center py-96 xl:py-40">
        <div className="lg:w-3/5 xl:w-2/5 flex flex-col items-start relative z-10">
          <span className="hidden ont-bold uppercase text-pink-400">
            Confirmation
          </span>
