                ...
                >
                  ...
                  <div>
                    <input
                      ...
                      className="email w-full bg-gray-100 dark:bg-gray-300  bg-opacity-50 rounded border border-gray-300 dark:border-gray-200 focus:bg-transparent focus:ring-2 focus:ring-pink-200 focus:border-pink-500 text-base outline-none text-gray-700 dark:text-gray-200 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
                      required
                    />
                    <button
                      type="submit"
                      value="Subscribe"
                      className="mt-4 lg:mt-2 xl:mt-4 flex-shrink-0 inline-flex text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded"
                    >
                      Subscribe
                    </button>
                  </div>
      ...
      <div className="bg-gray-100 dark:bg-gray-900">
        <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
          <a className="flex title-font font-bold items-center md:justify-start justify-center text-black dark:text-gray-100">
            ...
            <span className="ml-3 text-xl">Polanka</span>
          </a>
          <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">
            &copy; {new Date().getFullYear()} Polanka, Inc. All rights
            reserved.
            <a href="/"></a>
          </p>
