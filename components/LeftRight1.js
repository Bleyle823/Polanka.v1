    ...
    <div className="px-4 mx-auto max-w-7xl sm:px-6 md:px-12 lg:px-24 lg:py-24 dark:text-neutral-200">
      <div className="flex flex-wrap items-center mx-auto max-w-7xl">
        <div className="visible lg:hidden flex flex-col items-center lg:items-start sm:mt-12 mb-16 text-left lg:flex-grow lg:w-1/2 lg:pl-6 xl:pl-24 md:mb-0 xl:mt-0 m-auto sm:pb-20">
          <span className="mb-8 text-xs font-bold text-pink-600 uppercase animate-none sm:animate-pulse">
          ...
          <div className="mt-0 lg:mt-6 max-w-7xl sm:flex">
            <div className="mt-3 rounded-lg sm:mt-0">
              <button className=" items-center block px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-pink-600 rounded-xl hover:bg-pink-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 ">
        ...
        <div className="w-full lg:max-w-lg lg:w-1/2 rounded-xl">
          <div>
            <div className="relative w-full max-w-lg m-auto">
              <div className="absolute top-0 rounded-full bg-pink-300 -left-4 w-72 h-72 mix-blend-multiply filter blur-xl opacity-70 animate-blob "></div>
              <div className="absolute rounded-full bg-pink-300 -bottom-24 right-20 w-72 h-72 mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
        ...
        <div className="hidden lg:flex flex-col items-center lg:items-start mt-12 mb-16 text-left lg:flex-grow lg:w-1/2 lg:pl-6 xl:pl-24 md:mb-0 xl:mt-0 m-auto">
          <span className="mb-8 text-xs font-bold text-pink-600 uppercase">
          ...
          <div className="mt-0 lg:mt-6 max-w-7xl sm:flex">
            <div className="mt-3 rounded-lg sm:mt-0">
              <a href="https://shop.modernapparel.ga/search">
                <button className=" items-center block px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-pink-600 rounded-xl hover:bg-pink-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ">
